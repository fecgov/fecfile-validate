...
describe(`validate('F3X')`, () => {
  ...
  describe('filer_committee_id_number', () => {
    it("should not be ''", () => {
      ...
      expect(validate('F3X', thisData).errors).toEqual([
        'filer_committee_id_number must NOT have fewer than 9 characters',
      ]);
    });
    it('is too short', () => {
    ...
    it('is too long', () => {
      ...
      expect(validate('F3X', thisData).errors).toEqual([
        'filer_committee_id_number must NOT have more than 9 characters',
      ]);
    });
