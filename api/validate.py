...
list_SA_similar_INDV_REC_transactionTypeCode = ["INDV_REC", "PAR_MEMO", "IK_REC", "IK_BC_REC", "REATT_FROM", "REATT_TO", "RET_REC", "EAR_REC", "COND_EARU", "COND_EARD", "IND_RECNT", "IND_NP_RECNT", "IND_HQ_ACCNT", "IND_CO_ACCNT", "IND_CAREY", "IND_JF_MEM", "IND_JF_R_MEM", "IND_JF_C_MEM", "IND_JF_H_MEM", "EAR_IND_RECT", "EAR_REC_CONV", "EAR_REC_HEAD"]
...
list_SA_similar_COND_EARM_PAC_transactionTypeCode = ["COND_E_PACU", "COND_E_PACD", "EAR_REC_PAC", "EAR_MEMO_PAC", "IK_REC_PTY", "IK_REC_PAC", "PTY_REC", "PAC_REC", "NF_PAC_REC", "NPAC_RET", "PAC_RET", "PAR_RET", "TRAN", "REF_FED_CAN", "PTY_RCNT", "PAC_RCNT", "TRI_RCNT", "PTY_NP_RCNT", "PAC_NP_RCNT", "PTY_HQ_ACCNT", "PAC_HQ_ACCNT", "PTY_CO_ACCNT", "PAC_CO_ACCNT", "OT_COM_CAREY", "IK_TRAN","IK_TRAN_FEA", "JF_TRAN", "PTY_JF_MEM", "PAC_JF_MEM", "JF_TRAN_R", "PAC_JF_R_MEM", "JF_TRAN_C", "PAC_JF_C_MEM", "JF_TRAN_H", "PAC_JF_H_MEM","EAR_PAC_REC", "EAR_CONV_REC", "EAR_HEAD_ACC"]
